...
var __main = function __main() {
    _sea2.default.use = function (ids, callback) {
        _module2.default.preload(function () {
            _module2.default.use(ids, callback, data.cwd + '_use_' + cid());
        });
        return _sea2.default;
    };
};
...
var cachedMods = _sea2.default.cache = {}; /**
...
Module.prototype.fetch = function (requestCache) {
    ...
    function sendRequest() {
        _sea2.default.request(emitData.requestUri, emitData.onRequest, emitData.charset, emitData.crossorigin);
    }
...
Module.resolve = function (id, refUri) {
    ...
    return emitData.uri || _sea2.default.resolve(emitData.id, refUri);
};
...
_sea2.default.Module = Module;
data.fetchedList = fetchedList;
data.cid = cid;

_sea2.default.require = function (id) {
 ...
 */
_sea2.default.on = function (name, callback) {
...
// for all events
_sea2.default.off = function (name, callback) {
  // Remove *all* events
  if (!(name || callback)) {
    events = data.events = {};
    return _sea2.default;
...
var emit = _sea2.default.emit = function (name, data) {
  var list = events[name],
      fn;
