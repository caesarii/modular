define(function(require) {
  ...
  assert(dirname('./a/b/c.js') === './a/b/', '_dirname')
  assert(dirname('a/b/c.js') === 'a/b/', '_dirname')
  assert(dirname('/a/b/c.js') === '/a/b/', '_dirname')
  assert(dirname('/d.js') === '/', '_dirname')
  assert(dirname('/') === '/', '_dirname')
  assert(dirname('/xxx') === '/', '_dirname')
  assert(dirname('http://cdn.com/js/file.js') === 'http://cdn.com/js/', '_dirname')
  assert(dirname('http://cdn.com/js/file.js?t=xxx') === 'http://cdn.com/js/', '_dirname')
  assert(dirname('http://cdn.com/js/file.js?t=xxx#zzz') === 'http://cdn.com/js/', '_dirname')
  assert(dirname('http://example.com/page/index.html#zzz?t=xxx') === 'http://example.com/page/', '_dirname')
  assert(dirname('http://example.com/arale/seajs/1.2.0/??sea.js,seajs-combo.js') === 'http://example.com/arale/seajs/1.2.0/', '_dirname')
  assert(dirname('http://cdn.com/??seajs/1.2.0/sea.js,jquery/1.7.2/jquery.js') === 'http://cdn.com/', '_dirname')
  assert(dirname('http://seajs.com/docs/#/abc') === 'http://seajs.com/docs/', '_dirname')
  //assert(_dirname('') === null, '_dirname')
  ...
  assert(parseAlias('jquery-debug') === 'jquery/1.8.0/jquery-debug', '_parseAlias')
  assert(parseAlias('app') === 'app/1.2/app', '_parseAlias')
  assert(parseAlias('alias/a') === 'path/to/biz/a.js', '_parseAlias')
  assert(parseAlias('./alias/b') === 'path/to/b.js', '_parseAlias')
  assert(parseAlias('/alias/c') === 'c.js', '_parseAlias')
  assert(parseAlias('http://test.com/router') === 'router.js?t=20110525', '_parseAlias')
  ...
  assert(parsePaths('xx-path/a') === 'http://xx.com/path/to//a', '_parsePaths')
  assert(parsePaths('/xx-path/a') === '/xx-path/a', '_parsePaths')
  assert(parsePaths('xx/path/a') === 'xx/path/a', '_parsePaths')
  assert(parsePaths('http://xx/path/xx-path/') === 'http://xx/path/xx-path/', '_parsePaths')
  assert(parsePaths('/') === '/', '_parsePaths')
  assert(parsePaths('.') === '.', '_parsePaths')
  ...
  assert(parseVars('./i18n/{locale}.js') === './i18n/zh-cn.js', '_parseVars')
  assert(parseVars('{biz}/js/x') === 'path/to/biz/js/x', '_parseVars')
  assert(parseVars('/js/{xx}/c.js') === '/js/./xx/c.js', '_parseVars')
  assert(parseVars('/js/{xx}/{zz}') === '/js/./xx/zz.js', '_parseVars')
  assert(parseVars('{a/b}') === 'path/to/a/b.js', '_parseVars')
  assert(parseVars('{not-existed}') === '{not-existed}', '_parseVars')
  assert(parseVars('{c}') === '{path}/to/c.js', '_parseVars')


  var CWR = cwd.match(/^.*?\/\/.*?\//)[0]

  assert(addBase('http://a.com/b.js') === 'http://a.com/b.js', '_addBase')
  assert(addBase('./a.js', 'http://test.com/path/b.js') === 'http://test.com/path/a.js', '_addBase')
  assert(addBase('/b.js', 'http://test.com/path/to/c.js') === CWR + 'b.js', '_addBase')
  assert(addBase('c', 'http://test.com/path/to/c.js') === cwd + 'c', '_addBase')
  ...
  assert(parseMap('path/to/aa.js') === 'path/to/aa-debug.js', '_parseMap')
  assert(parseMap('jquery/2.0.0/jquery') === 'http://localhost/jquery.js', '_parseMap')
  assert(parseMap('jquery/2.0.0/jquery-debug') === 'http://localhost/jquery.js', '_parseMap')
  assert(parseMap('path/to/js/a') === 'path/to/script/a', '_parseMap')
  assert(parseMap('path/to/function/b') === 'http://test.com/path/to/function.js', '_parseMap')
  assert(parseMap('cc.js') === './cc.js', '_parseMap')
