...
!function (a, b) {
    ...
    function j (a) {
        var b = v.vars
        return b && a.indexOf('{') > -1 && (a = a.replace(J, function (a, c) {return x(b[c]) ? b[c] : a})), a
    }
    ...
    function p (a, c, d, e) {
        function f () {a.onload = a.onerror = a.onreadystatechange = null, d || v.debug || R.removeChild(a), a = null, c()}
        ...
        }) : a.onreadystatechange = function () {/loaded|complete/.test(a.readyState) && f()}, b) : (setTimeout(function () {q(a, c)}, 1), b)
    }
    
    function q (a, b) {
        var c = a.sheet, d
        if (W) c && (d = !0) else if (c) try {c.cssRules && (d = !0)} catch (e) {'NS_ERROR_DOM_SECURITY_ERR' === e.name && (d = !0)}
    ...
    function s (a) {
        var b = []
        return a.replace(Y, '').replace(X, function (a, c, d) {d && b.push(d)}), b
    }
    ...
    if (!a.seajs) {
        ...
        }, t.get = function (a, b) {return Z[a] || (Z[a] = new t(a, b))}, t.use = function (b, c, d) {
        ...
        }, u.use = function (a, b) {return t.preload(function () {t.use(a, b, v.cwd + '_use_' + d())}), u}, t.define.cmd = {}, a.define = t.define, u.Module = t, v.fetchedList = ab, v.cid = d, u.require = function (a) {
        ...
        v.base = (Q.match(db) || ['', Q])[1], v.dir = Q, v.cwd = N, v.charset = 'utf-8', v.preload = function () {
            ...
            return b += ' ' + M.cookie, b.replace(/(seajs-\w+)=1/g, function (b, c) {a.push(c)}), a
        }(), u.config = function (a) {
            for (var b in a) {
                var c = a[b], d = v[b]
